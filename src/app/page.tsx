                  ...
                  <div className="z-10 sm:order-2 sm:col-span-6">
                    <h3>
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer noopener"
                        aria-label="Pizza shop website (opens in a new tab)"
                      >
                        <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                        <span>
                    ...
                    <p className="mt-2 text-sm leading-normal">
                      Mobile-first web app that enables users to search the
                      Spotify library, curate custom playlists, and save them
                ...
                <div className="group relative grid gap-4 pb-1 sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                  ...
                  <div className="z-10 sm:order-2 sm:col-span-6">
                    <h3>
                      <a
                        className="inline-flex items-baseline font-medium leading-tight hover:text-cyan-400 focus-visible:text-cyan-400  group/link text-base"
                        href="https://izza-umber.vercel.app/"
                        target="_blank"
                        rel="noreferrer noopener"
                        aria-label="Pizza Shop Website (opens in a new tab)"
                      >
                    ...
                    <p className="mt-2 text-sm leading-normal">
                      AUthentic Italian pizza shop website, showcasing a
                      selection of pizzas, with a focus on responsive design and
                      user experience.
                    </p>
                    <ul
                      className="mt-2 flex flex-wrap"
                  ...
                  <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                    ...
                    <div className="z-10 sm:col-span-6">
                      ...
                      <p className="mt-2 text-sm leading-normal">
                        ...
                        industry-recognized certifications. Built a
                        professional-grade portfolio through guided real-world
                        projects, demonstrating practical skills in responsive
                        design, dynamic web applications, and version control.
                      </p>
                      <ul
                        className="mt-2 flex flex-wrap"
